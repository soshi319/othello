...
def banmen():
    cvs.delete("all")
    cvs.create_text(320, 670, text=msg, fill="white", font="游ゴシック")
    for y in range(8):
        for x in range(8):
            X = x*80
            Y = y*80
...
def main():
    ...
    if proc==0: # タイトル画面
        msg = "先手、後手を選んでください"
        cvs.create_text(320, 200, text="Reversi", fill="gold", font=("游ゴシック",50))
        cvs.create_text(160, 440, text="先手(黒)", fill="black", font=("游ゴシック",30))
        cvs.create_text(480, 440, text="後手(白)", fill="white", font=("游ゴシック",30))
        ...
        if turn==0: # プレイヤー
            ...
            MONTE = [600, 600, 500, 300, 300, 300, 100]
